...
std::optional<Price> EffectivePriceCalculator::calculateEffectiveAsk(Price sellerPrice, GridZoneId sellerZone, GridZoneId buyerZone, const config::GridTransferCache& cache)
{
...
std::optional<Price> EffectivePriceCalculator::calculateEffectiveBid(Price buyerLimitPrice, GridZoneId sellerZone, GridZoneId buyerZone, const config::GridTransferCache& cache)
{
    if (sellerZone == buyerZone)
    {
