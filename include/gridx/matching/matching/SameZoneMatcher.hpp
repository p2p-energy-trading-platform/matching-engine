...
private:
     ...
     */
    [[nodiscard]]
    MatchingResult matchBuy(Order incomingBuy, const orderbook::ZoneOrderBook& zoneBook) const;

    /**
     * Matches an incoming SELL order against the BUY book.
     */
    [[nodiscard]]
    MatchingResult matchSell(Order incomingSell, const orderbook::ZoneOrderBook& zoneBook) const;
