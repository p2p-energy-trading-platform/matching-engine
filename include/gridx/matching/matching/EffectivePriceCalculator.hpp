...
public:
    ...
    [[nodiscard]]
    static std::optional<Price> calculateEffectiveAsk(Price sellerPrice, GridZoneId sellerZone,
                                                      GridZoneId buyerZone,
    ...
    [[nodiscard]]
    static std::optional<Price> calculateEffectiveBid(Price buyerLimitPrice, GridZoneId sellerZone,
                                                      GridZoneId buyerZone,
                                                      const config::GridTransferCache& cache);
};
